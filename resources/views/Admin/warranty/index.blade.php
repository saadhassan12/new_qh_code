...
@section('contents')
    ...
    <div class="row">
            ...
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @include('Admin.warranty.data-table')
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="col-md-6 m-t-30">
            ...
            <div id="js-add-warranty-modal" class="modal" data-bs-backdrop='static' tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
