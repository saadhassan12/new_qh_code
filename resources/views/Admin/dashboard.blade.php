        ...
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary mini-stat position-relative">
                    <div class="card-body">
                        <h6 class="text-uppercase mt-0 text-white-50">Desktop</h6>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
                                    <p class="text-white-100">Active</p>
                                    <h4 class="mb-3 mt-0">20</h4>
                                </div>
                            </div></div>
                            <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
                                    <p class="text-white-100">Instock</p>
                                    <h4 class="mb-3 mt-0">15</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
                                    <p class="text-white-100">Dead</p>
                                    <h4 class="mb-3 mt-0">3</h4>
                                </div>
                            </div>
                        </div>
                        </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary mini-stat position-relative">
                    <div class="card-body">
                        <h6 class="text-uppercase mt-0 text-white-50">Laptop</h6>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary mini-stat position-relative">
                    <div class="card-body">
                        <h6 class="text-uppercase mt-0 text-white-50">Printer</h6>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary mini-stat position-relative">
                    <div class="card-body">
                        <h6 class="text-uppercase mt-0 text-white-50">Scanner</h6>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mini-stat-desc">
                                <div class="text-white">
